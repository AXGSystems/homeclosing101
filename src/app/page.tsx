...
const stats = [
  ...
  { value: "28", end: 28, suffix: "", label: "Closing Checklist", ...palette[6], href: "/closing-process/closing-checklist", preview: "Interactive 28-item checklist across 5 phases — track your progress online.",
    icon: <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
  { value: "A.i.", end: 0, suffix: "", staticValue: "A.i.", label: "ALTA Intelligence Assistant", ...palette[7], href: "/faq", preview: "Ask HomeClosing101 any question related to the closing process — instant answers anytime.",
