...
const stats = [
  ...
  { value: "A.i.", end: 0, suffix: "", staticValue: "A.i.", label: "ALTA Intelligence A.i. \u2122", ...palette[7], href: "/faq", preview: "Ask ALTA Intelligence any question about closing — instant answers anytime.",
