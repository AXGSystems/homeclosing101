...
// 3-color rotation: teal, frosty silver, red
const teal   = { color: "from-[#0a7ea8]/30 to-[#0a7ea8]/10", accent: "text-[#5ec4e6]" };
const silver = { color: "from-[#94a3b8]/30 to-[#94a3b8]/10", accent: "text-[#c8d6e5]" };
const red    = { color: "from-[#943030]/30 to-[#943030]/10", accent: "text-[#f87171]" };
const palette = [teal, silver, red, teal, silver, red, teal, silver];

const stats = [
  { value: "30+", end: 30, suffix: "+", label: "In-Depth Guides", ...palette[0], href: "/closing-process", preview: "Step-by-step guides covering every phase from pre-approval to getting the keys.",
  ...
  { value: "250+", end: 250, suffix: "+", label: "FAQ Answers", ...palette[1], href: "/faq", preview: "Verified answers sourced from CFPB, FBI, ALTA, NAR, and more.",
    icon: <svg viewBox="0 0 24 24" className="w-9 h-9" fill="none" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" /></svg> },
  { value: "450+", end: 450, suffix: "+", label: "Glossary Terms", ...palette[2], href: "/glossary", preview: "Searchable real estate terms with examples you can save and print.",
  ...
  { value: "8", end: 8, suffix: "", label: "Calculators & Tools", ...palette[3], href: "/mortgage-calculator", preview: "Mortgage, affordability, DTI, rent-vs-buy, closing costs, and more.",
  ...
  { value: "8", end: 8, suffix: "", label: "Closing Steps", ...palette[4], href: "/closing-process/what-to-expect", preview: "The complete 8-step journey from finances to keys — with detailed walkthroughs.",
...
const resources = [
  ...
  { name: "Mortgage Bankers Association (MBA)", desc: "Home Loan Learning Center — consumer mortgage education, rate data, and ALTA partner on RON advocacy", url: "https://www.mba.org/home-loan-learning-center", logo: "https://www.google.com/s2/favicons?domain=mba.org&sz=64", halo: "#003366" },
  { name: "MISMO (Mortgage Industry Standards Org.)", desc: "MBA subsidiary publishing the ALTA dataset standards that enable modern title and closing workflows", url: "https://www.mismo.org/", logo: "https://www.google.com/s2/favicons?domain=mismo.org&sz=64", halo: "#1a5276" },
    ...
    <>
      ...
      <section className="relative text-white py-8 lg:py-14 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          {/* Hero copy */}
          <SectionGate page="/" id="hero" sub="hero-copy">
      ...
      <SectionGate page="/" id="why-it-matters">
      <section className="py-12 lg:py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <SectionGate page="/" id="why-it-matters" sub="data-points">
          ...
          {/* Pull quote */}
          <SectionGate page="/" id="why-it-matters" sub="pull-quote">
          ...
          <SectionGate page="/" id="why-it-matters" sub="market-stats">
      ...
      <section className="py-14 lg:py-20 bg-[#f0f1f3]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          {/* Why ALTA does this */}
          <SectionGate page="/" id="how-it-helps" sub="why-alta">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-10">
            <div className="bg-gradient-to-br from-[#0a7ea8]/10 to-white rounded-xl p-5 shadow-sm border border-[#0a7ea8]/20 border-l-4 border-l-[#0a7ea8] text-center hover:-translate-y-1 hover:shadow-md transition-all duration-200">
              ...
              <p className="text-xs text-[#0a7ea8] mt-2 font-medium">Source: NAR 2025</p>
            </div>
            <div className="bg-gradient-to-br from-[#94a3b8]/10 to-white rounded-xl p-5 shadow-sm border border-[#94a3b8]/20 border-l-4 border-l-[#94a3b8] text-center hover:-translate-y-1 hover:shadow-md transition-all duration-200">
              <svg className="w-8 h-8 mx-auto mb-3 text-[#64748b]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" /></svg>
              ...
              <p className="text-xs text-[#64748b] mt-2 font-medium">Source: CFPB</p>
            </div>
            <div className="bg-gradient-to-br from-[#943030]/10 to-white rounded-xl p-5 shadow-sm border border-[#943030]/20 border-l-4 border-l-[#943030] text-center hover:-translate-y-1 hover:shadow-md transition-all duration-200">
              <svg className="w-8 h-8 mx-auto mb-3 text-[#943030]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" /></svg>
          ...
          {/* Blurb */}
          <SectionGate page="/" id="roadmap" sub="blurb">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link href="/faq" className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/10 hover:bg-[#0a8ebc]/30 hover:border-[#0a8ebc]/40 transition-colors text-center">
              ...
              <Link href="/stop-fraud" className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/10 hover:bg-[#0a8ebc]/30 hover:border-[#0a8ebc]/40 transition-colors text-center">
