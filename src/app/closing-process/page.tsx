        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="mb-6 p-4 bg-gradient-to-br from-alta-light to-white rounded-2xl border border-gray-100 sticky top-[130px] sm:top-[142px] z-20 shadow-md">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="font-bold text-alta-navy mb-1">Navigate Your Closing Journey</h2>
                <p className="text-sm text-alta-gray leading-relaxed">Choose a topic below to learn about each phase of the closing process. From understanding what to expect to using our interactive cost calculator, these guides will prepare you for a smooth, confident closing.</p>
              </div>
            </div>
          </div>
