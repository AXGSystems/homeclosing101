      ...
      >
        <div className="flex items-center gap-4 p-3 sm:p-4">
          ...
          <div className="w-28 sm:w-36 shrink-0 flex items-center justify-center">
            ...
            <img src={s.logo} alt={s.name} className="h-10 sm:h-12 w-auto object-contain max-w-[130px]" onError={(e) => { if (!e.currentTarget.src.endsWith('/logos/alta.svg')) e.currentTarget.src = '/logos/alta.svg'; }} />
          </div>
          {/* Content */}
          <div className="flex-1 min-w-0">
