    ...
    <>
      ...
      <div className="py-1.5 lg:py-2">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <SectionGate page="/loan-estimate" id="intro-callout">
          ...
          <SectionGate page="/loan-estimate" id="apr-example">
          ...
          <div className="mt-8 mb-4">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              ...
              <Link href="/mortgage-calculator" className="p-4 bg-[#f0ecf6] rounded-xl border border-[#d4c8e4] border-l-4 border-l-[#5b3a8c] tile-interactive group">
                ...
                <p className="text-xs text-alta-gray mt-1">Calculate your monthly payments including taxes and insurance</p>
              </Link>
          ...
          <div className="relative bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] sm:max-h-[85vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6">
              ...
              <div className="mt-4 pt-3 border-t border-gray-100">
                <SaveToFolderBtn type="note" title={activeModal.title} content={`Loan Estimate detail: ${activeModal.title}`} />
              </div>
            </div>
          </div>
        </div>
