...
const sectionStyles: Record<string, { color: string; icon: string; image: string }> = {
  "Buying a Home": { color: "from-blue-500 to-blue-600", icon: "M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25", image: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=600&q=80" },
  "Sample Closing Documents": { color: "from-amber-500 to-amber-600", icon: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z", image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&q=80" },
  "Fraud Reporting & Prevention": { color: "from-red-500 to-red-600", icon: "M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z", image: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&q=80" },
  "Industry & Real Estate Organizations": { color: "from-green-500 to-green-600", icon: "M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&q=80" },
};
