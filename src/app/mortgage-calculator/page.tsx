    ...
    <>
      ...
      <div className="py-1.5 lg:py-2">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Loan type info bar */}
          <SectionGate page="/mortgage-calculator" id="calculator" sub="loan-info-bar">
          ...
          <SectionGate page="/mortgage-calculator" id="cfpb-tip">
          ...
          <SectionGate page="/mortgage-calculator" id="related-links">
