export interface StateInsuranceDept {
  ...
  phone: string;
  website: string;
  closingType?: "attorney" | "title" | "either";
  ronAvailable?: boolean;
  rateType?: "regulated" | "competitive";
}
...
export const stateInsuranceData: StateInsuranceDept[] = [
  ...
  { state: "California", abbr: "CA", department: "Department of Insurance", address: "300 South Spring St, 14th Floor, Los Angeles, CA 90013", phone: "800-927-4357", website: "https://insurance.ca.gov", closingType: "either", ronAvailable: true, rateType: "competitive" },
  ...
  { state: "Florida", abbr: "FL", department: "Office of Insurance Regulation", address: "200 East Gaines St, Tallahassee, FL 32399", phone: "850-413-3140", website: "https://floir.com", closingType: "either", ronAvailable: true, rateType: "regulated" },
  { state: "Georgia", abbr: "GA", department: "Office of Insurance and Safety Fire Commissioner", address: "2 Martin Luther King Jr. Dr, West Tower, Suite 702, Atlanta, GA 30334", phone: "404-656-2070", website: "https://oci.georgia.gov", closingType: "attorney", ronAvailable: true, rateType: "competitive" },
  ...
  { state: "Illinois", abbr: "IL", department: "Department of Insurance", address: "320 West Washington St, Springfield, IL 62767", phone: "217-782-4515", website: "https://insurance.illinois.gov", closingType: "either", ronAvailable: true, rateType: "regulated" },
  ...
  { state: "Michigan", abbr: "MI", department: "Dept. of Insurance and Financial Services", address: "530 West Allegan St, Lansing, MI 48933", phone: "517-284-8800", website: "https://michigan.gov/difs/", closingType: "either", ronAvailable: true, rateType: "regulated" },
  ...
  { state: "New York", abbr: "NY", department: "Department of Financial Services", address: "1 State St, New York, NY 10004", phone: "212-480-6400", website: "https://dfs.ny.gov", closingType: "attorney", ronAvailable: true, rateType: "regulated" },
  { state: "North Carolina", abbr: "NC", department: "Department of Insurance", address: "1201 Mail Service Center, Raleigh, NC 27699", phone: "855-408-1212", website: "https://ncdoi.gov", closingType: "attorney", ronAvailable: true, rateType: "regulated" },
  ...
  { state: "Ohio", abbr: "OH", department: "Department of Insurance", address: "50 West Town St, 3rd Floor, Suite 300, Columbus, OH 43215", phone: "614-644-2658", website: "https://insurance.ohio.gov", closingType: "either", ronAvailable: true, rateType: "regulated" },
  ...
  { state: "Pennsylvania", abbr: "PA", department: "Insurance Department", address: "1326 Strawberry Square, Harrisburg, PA 17120", phone: "717-787-7000", website: "https://insurance.pa.gov", closingType: "either", ronAvailable: true, rateType: "regulated" },
  ...
  { state: "Texas", abbr: "TX", department: "Department of Insurance", address: "1601 Congress Ave, Austin, TX 78701", phone: "512-676-6000", website: "https://tdi.texas.gov", closingType: "title", ronAvailable: true, rateType: "regulated" },
