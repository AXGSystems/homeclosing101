...
const stats = [
  ...
  {
    value: "1 in 4",
    label: "Buyers received suspicious messages during transactions",
    source: "CertifID",
    color: "from-purple-500 to-purple-600",
    hoverBg: "hover:bg-purple-50",
    hoverBorder: "hover:border-purple-300",
    detail: "According to CertifID's 2026 State of Wire Fraud Report, 25% of recent homebuyers reported receiving a suspicious email, text, or phone call during their real estate transaction. Additionally, 61% of buyers reported being worried about wire fraud during their closing process.",
