...
const industryResources = [
  ...
  { name: "Mortgage Bankers Association (MBA)", desc: "National trade association for the mortgage lending industry — consumer education and market data", url: "https://www.mba.org/home-loan-learning-center", logo: "https://www.google.com/s2/favicons?domain=mba.org&sz=64", brandColor: "#003366", bgTint: "bg-[#e8ecf5]", borderColor: "border-[#c5cfe4]", accentBorder: "border-l-[#003366]",
    modalContent: { what: "The Mortgage Bankers Association (MBA) is the national trade association representing the real estate finance industry — independent mortgage bankers, mortgage brokers, commercial banks, thrifts, life insurance companies, and others in the mortgage lending field. MBA partners closely with ALTA on industry advocacy, most notably co-authoring the model Remote Online Notarization (RON) legislation now adopted in 45 states.", resources: "MBA offers: the Home Loan Learning Center (consumer mortgage education), the Weekly Applications Survey (the industry's benchmark for mortgage demand, covering ~75% of retail applications since 1990), mortgage finance forecasts, credit and application guides, and MISMO — the industry data standards subsidiary that in March 2026 published new ALTA dataset standards for title and closing modernization.", whyItMatters: "If ALTA is the authority on your title and settlement, MBA is the authority on your mortgage. Their Home Loan Learning Center is the consumer-facing complement to HomeClosing101 on the lending side — credit reports, loan qualification, true cost of owning vs renting, and mortgage calculators. MBA's co-advocacy with ALTA has shaped consumer-friendly legislation like RON and the SECURE Notarization Act." }
  },
  { name: "MISMO (Mortgage Industry Standards Org.)", desc: "MBA subsidiary publishing ALTA dataset standards for title and closing modernization", url: "https://www.mismo.org/", logo: "https://www.google.com/s2/favicons?domain=mismo.org&sz=64", brandColor: "#1a5276", bgTint: "bg-[#e8f0f5]", borderColor: "border-[#c5d8e4]", accentBorder: "border-l-[#1a5276]",
    modalContent: { what: "MISMO (the Mortgage Industry Standards Maintenance Organization) is a nonprofit subsidiary of the Mortgage Bankers Association. Its role is to develop, publish, and maintain the data standards that let lenders, title agents, settlement platforms, and other industry participants exchange closing information in a consistent, machine-readable way. Think of MISMO as the plumbing that makes modern electronic closings possible.", resources: "MISMO publishes: data standards for loan origination, title insurance, closing, servicing, and secondary market transactions; ALTA dataset standards (two new specifications published March 2026) for title and closing modernization; the Mortgage Ready Workshop focused on early-stage homebuyer data standards; and certification programs for industry professionals who work with the standards.", whyItMatters: "Every time you sign a Closing Disclosure, receive a Loan Estimate, or complete a Remote Online Notarization, MISMO standards are working behind the scenes to let the systems involved talk to each other accurately. For consumers, MISMO's work means fewer errors, faster closings, and more interoperability between your lender, title company, and county recorder. ALTA and MISMO's partnership is particularly important because title insurance data is the most complex document set in a real estate transaction." }
  },
