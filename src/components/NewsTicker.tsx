...
const headlines = [
  ...
  { text: "MISMO publishes new ALTA dataset standards for title and closing modernization (March 2026)", source: "MISMO / ALTA", detail: "In March 2026, MISMO — the mortgage industry standards organization and subsidiary of the Mortgage Bankers Association — published two new ALTA dataset standards advancing title and closing modernization. The new standards improve data portability between lenders, title agents, and settlement platforms, and pave the way for faster closings and fewer errors. MISMO also launched a 'Mortgage Ready' Workshop focused on early-stage homebuyer data standards. This is another milestone in the ALTA/MBA partnership that previously delivered RON adoption in 45 states.", link: "/closing-process/closing-options" },
  { text: "MBA Weekly Applications Survey covers 75% of retail mortgage applications since 1990", source: "MBA", detail: "The Mortgage Bankers Association's Weekly Applications Survey is the industry benchmark for mortgage demand — covering approximately 75% of all U.S. retail residential mortgage applications. Respondents include mortgage bankers, commercial banks, thrifts, and credit unions. The survey tracks 15 indices covering fixed-rate, adjustable-rate, conventional, and government loans for both purchases and refinances. Check mba.org for the current week's data.", link: "/resources" },
];
