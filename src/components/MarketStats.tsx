...
const stats: StatItem[] = [
  ...
  { end: 75, prefix: "", suffix: "%", label: "Of mortgage applications tracked by MBA weekly", detail: "The MBA Weekly Applications Survey is the industry benchmark for mortgage demand — running continuously since 1990.", deepDive: "The Mortgage Bankers Association (MBA) Weekly Applications Survey is the mortgage industry's most-watched demand indicator. It has been conducted every week since 1990 and covers approximately 75% of all U.S. retail residential mortgage applications. Respondents include mortgage bankers, commercial banks, thrifts, and credit unions. The survey reports 15 indices covering fixed-rate, adjustable-rate, conventional, and government loans for both home purchases and refinances — giving the most accurate view of how rate movements and affordability changes affect real-world demand. MBA is also ALTA's co-advocacy partner on Remote Online Notarization, and its standards subsidiary MISMO publishes the data standards that let lenders and title companies exchange closing information. For the latest weekly numbers, visit mba.org.", source: "MBA", sourceUrl: "https://www.mba.org/news-and-research/research-and-economics/single-family-research/weekly-applications-survey", decimals: 0, image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=400&q=80", color: "from-[#003366] to-[#0a8ebc]" },
];
