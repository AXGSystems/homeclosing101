...
export const SITE_STRUCTURE: PageEntry[] = [
  {
    ...
    sections: [
      { id: "hero", label: "Hero", subs: [{ id: "hero-copy", label: "Hero Headline & CTAs" }, { id: "stat-tiles", label: "Stat Tiles Grid" }] },
      { id: "why-it-matters", label: "Why This Matters", subs: [{ id: "data-points", label: "Key Data Points" }, { id: "pull-quote", label: "Mission Pull Quote" }, { id: "market-stats", label: "2025 Market Stats" }] },
      { id: "how-it-helps", label: "How HomeClosing101 Helps", subs: [{ id: "why-alta", label: "Why ALTA Does This" }, { id: "pillars", label: "Learn / Calculate / Protect Pillars" }] },
      { id: "feature-cards", label: "Feature Cards" },
      { id: "roadmap", label: "Road to Homeownership", subs: [{ id: "data-cards", label: "Roadmap Data Cards" }, { id: "blurb", label: "Roadmap Blurb & CTA" }] },
      { id: "where-to-start", label: "Where Should I Start?" },
      { id: "title-insurance", label: "Why Title Insurance Matters" },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "explore-phases", label: "Explore Each Phase Callout" },
      { id: "timeline", label: "Visual Flow Timeline" },
      { id: "step-cards", label: "Closing Phase Step Cards" },
      { id: "stats", label: "Key Closing Stats" },
  ...
  { route: "/closing-disclosure", label: "Closing Disclosure", navGroup: "Closing Process", sections: [] },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "welcome-intro", label: "Welcome Intro" },
      { id: "quick-tools", label: "Quick-Access Tools" },
      { id: "timeline", label: "Homebuying Timeline" },
      { id: "stat-first-time-share", label: "Stat: First-Time Buyer Share" },
      { id: "loan-types", label: "Understanding Loan Types" },
      { id: "common-mistakes", label: "Costly Mistakes" },
      { id: "stat-loan-shopping", label: "Stat: Lender Shopping Savings" },
      { id: "mba-resource", label: "MBA Learning Center Resource" },
  ...
  },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "intro", label: "Intro: Compare Loan Types" },
      { id: "calculator", label: "Calculator", subs: [{ id: "loan-type-selector", label: "Loan Type Selector" }, { id: "loan-type-info", label: "Loan Type Info Bar" }, { id: "inputs-results", label: "Inputs & Results" }] },
      { id: "rate-shopping-tip", label: "Rate Shopping Tip" },
      { id: "detailed-analysis", label: "Detailed Analysis", subs: [{ id: "cash-and-insurance", label: "Cash Needed & Mortgage Insurance" }, { id: "property-tax-context", label: "Property Tax Context" }, { id: "cost-totals", label: "Cost Totals" }] },
  ...
  },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "stat-callout", label: "$21,000 Surprise Callout" },
      { id: "calculator", label: "Cost Calculator", subs: [{ id: "inputs", label: "Calculator Inputs" }, { id: "results", label: "Results Panel" }] },
      { id: "hidden-costs", label: "Hidden Costs Tiles" },
  ...
  },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "intro-callout", label: "Intro: First Look at the Numbers" },
      { id: "trid-explainer", label: "TRID / TILA / RESPA Explainer" },
      { id: "timeline", label: "When You'll Receive It (Timeline)" },
      { id: "page-breakdown", label: "Page-by-Page Breakdown" },
      { id: "red-flags", label: "Red Flags to Watch For" },
      { id: "how-to-compare", label: "How to Compare Loan Estimates" },
      { id: "apr-example", label: "Why APR Matters (Example)" },
  ...
  },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "intro", label: "Intro / Protect Your Investment Banner" },
      { id: "comparison", label: "Homeowner's vs Title Insurance Breakdown", subs: [{ id: "side-by-side-cards", label: "Side-by-Side Cards" }, { id: "comparison-table", label: "Head-to-Head Comparison Table" }, { id: "scenarios", label: "Real-World Scenarios" }, { id: "without-coverage", label: "What Happens Without Coverage" }, { id: "bottom-line", label: "Bottom Line: You Need Both" }] },
      { id: "coverage", label: "What Homeowner's Insurance Covers" },
      { id: "exclusions", label: "What It Does NOT Cover" },
      { id: "how-to-shop", label: "How to Shop for Insurance" },
      { id: "cost", label: "What Does Insurance Cost?" },
      { id: "declarations", label: "Understanding Your Declarations Page" },
      { id: "file-claim", label: "How to File a Claim" },
      { id: "cta", label: "CTA Buttons" },
  ...
  },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "bundle-of-rights", label: "The Bundle of Rights" },
      { id: "limitations", label: "What Can Limit Your Rights" },
      { id: "fair-housing", label: "Fair Housing Act Protections", subs: [{ id: "classes-and-violations", label: "Protected Classes & Violations" }, { id: "complaints-and-state", label: "Filing Complaints & State Protections" }] },
      { id: "mineral-rights", label: "Mineral & Surface Rights" },
      { id: "transaction-rights", label: "Rights During a Transaction" },
      { id: "adverse-possession", label: "Adverse Possession & Boundaries" },
      { id: "protecting-rights", label: "Protecting Your Rights" },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "policy-distinction", label: "Lender's vs Owner's Policy" },
      { id: "protects-against", label: "What It Protects Against" },
      { id: "covered-scenarios", label: "What Title Insurance Covers" },
      { id: "title-search-process", label: "Title Search Process" },
      { id: "covered-risks", label: "What Owner's Policy Covers" },
      { id: "the-math", label: "The Math: Why It's Worth It" },
      { id: "cost-and-claims", label: "Cost & Filing a Claim", subs: [{ id: "cost-and-shop", label: "Cost & Right to Shop" }, { id: "filing-a-claim", label: "Filing a Claim" }] },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "protect-yourself", label: "How to Protect Yourself", subs: [{ id: "protection-steps", label: "Protection Steps" }, { id: "title-lock-note", label: "Title Lock Services Note" }] },
      { id: "comparison", label: "Title Lock vs. Title Insurance" },
      { id: "victim-steps", label: "What to Do If You're a Victim" },
      { id: "role-of-title-insurance", label: "Role of Title Insurance" },
      { id: "related-topics", label: "Related Topics" },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "stats", label: "HOA by the Numbers" },
      { id: "pros-cons", label: "Pros and Cons", subs: [{ id: "pros", label: "Advantages" }, { id: "cons", label: "Disadvantages" }] },
      ...
      { id: "special-assessments", label: "Special Assessments Explained" },
      ...
      { id: "hoa-insurance", label: "HOA Insurance Explained" },
      ...
      { id: "print-save", label: "Print / Save Buttons" },
      { id: "related-topics", label: "Related Topics" },
    ],
  },
  {
  ...
  { route: "/resources", label: "Resources", navGroup: "Resources", sections: [] },
  {
    ...
    sections: [
      ...
      { id: "sponsor-tip", label: "Sponsor Tip" },
      { id: "game-over", label: "Game Over Screen" },
      { id: "board", label: "Jeopardy Board" },
      { id: "how-to-play", label: "How to Play" },
      { id: "achievements", label: "Achievements", subs: [{ id: "progress", label: "Progress Bar" }, { id: "grid", label: "Achievement Grid" }] },
    ],
  },
  {
    ...
    sections: [
      { id: "hero", label: "Page Hero" },
      { id: "intro", label: "Intro: Find a Trusted Title Professional" },
      { id: "search", label: "Search ALTA Member Directory" },
      { id: "results", label: "Search Results (Directory)" },
      { id: "five-questions", label: "5 Questions to Ask" },
      { id: "best-practices-logos", label: "Best Practices Provider Logos" },
      { id: "respa-did-you-know", label: "RESPA Did You Know Callout" },
      { id: "why-alta-membership", label: "Why ALTA Membership Matters" },
      { id: "tips", label: "Tips for Choosing a Title Company" },
      { id: "right-to-shop", label: "Your Right to Shop" },
      { id: "sidebar", label: "Right Sidebar (Sponsors & State Partners)" },
    ],
  },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "intro", label: "Intro: 3 Ways to Locate Your Policy" },
      { id: "quick-stats", label: "Quick Stats" },
      { id: "steps", label: "3 Steps Grid" },
      { id: "interactive-map", label: "Interactive State Map" },
      { id: "when-to-contact", label: "When to Contact Your State Insurance Dept." },
      { id: "calling-script", label: "Sample Calling Script" },
      { id: "directory", label: "Searchable State Directory" },
  ...
  },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "intro", label: "Verified & Transparent Intro" },
      { id: "source-list", label: "Source List by Category" },
  ...
  },
  {
    ...
    sections: [
      { id: "hero", label: "Hero" },
      { id: "print-toolbar", label: "Print Toolbar" },
